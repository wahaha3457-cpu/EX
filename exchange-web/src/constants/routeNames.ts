export const RouteNames = {
  ...
  Convert: 'Convert',
  /** C2C 子路由（与旧 `C2C` 入口区分：主导航请指向 C2CMarket） */
  C2CMarket: 'C2CMarket',
  /** 进行中订单：filter = all | unpaid | paid | appeal */
  C2COrdersRunning: 'C2COrdersRunning',
  /** 已结束订单：filter = all | completed | cancelled */
  C2COrdersEnded: 'C2COrdersEnded',
  /** @deprecated 请使用 C2CMarket；保留字符串兼容旧链接 */
  C2C: 'C2CMarket',
  /** 币安式 USDT 交割 / 季度合约交易台 */
  ...
  /** 全球资讯 · 站内全文页 */
  MoreGlobalNewsArticle: 'MoreGlobalNewsArticle',
  MoreNft: 'MoreNft',
