...
/* 压住 EP 嵌套 menu 的 calc 左缩进，三级文字整体左移 */
.admin-menu-nodes__sub--d1 :deep(.el-menu--inline > .el-menu-item),
.admin-menu-nodes__sub--d1 :deep(.el-menu--inline .el-menu--inline > .el-menu-item) {
  position: relative;
  margin-bottom: 2px;
...
.admin-menu-nodes__sub--d1 :deep(.el-menu--inline > .el-sub-menu > .el-sub-menu__title) {
...
.admin-menu-nodes__sub--d1 :deep(.el-menu--inline .el-menu--inline > .el-menu-item::before) {
  left: -16px;
}
...
.admin-menu-nodes__sub--d2 :deep(.el-menu--inline > .el-menu-item),
.admin-menu-nodes__sub--d2 :deep(.el-menu--inline .el-menu--inline > .el-menu-item) {
  padding-left: 8px !important;
}

.admin-menu-nodes__sub--d2 :deep(.el-menu--inline > .el-sub-menu > .el-sub-menu__title) {
  padding-left: 8px !important;
}
